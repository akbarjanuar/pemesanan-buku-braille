...
Route::middleware(['auth', AdminMiddleware::class])->group(function () {
    ...
    // Pintu Masuk Utama Admin (Mengarahkan Berdasarkan Divisi)
    Route::get('/admin/dashboard', [AdminController::class, 'redirectDashboardAdmin'])->name('admin.dashboard');

    // 1. Dashboard Khusus Admin Literasi Digital
    ...
    // 2. Dashboard Khusus Admin Pengiriman
    ...
    // Kelola Buku (Lengkap dengan Rute Tambah & Edit)
