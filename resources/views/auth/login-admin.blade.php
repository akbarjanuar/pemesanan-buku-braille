...
<head>
    ...
    <title>Login Admin - BrailleKita</title>
    ...
    <div class="card">
        ...
        <form method="POST" action="/login-admin">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-control" placeholder="Masukkan alamat email admin" value="{{ old('email') }}" required autofocus>
            </div>
