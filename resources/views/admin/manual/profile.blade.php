...
<body>
        ...
        <header class="topbar">
            ...
            <div class="topbar-right">
                <i class="far fa-bell notification-bell"
                    style="font-size: 18px; color: var(--text-muted); cursor: pointer;"></i>
            </div>
        </header>
                ...
                <div class="profile-grid">
                    ...
                    <div class="card profile-center">
                        ...
                        <div class="profile-role">
                            Admin &middot; Sentra Wyata Guna Bandung
                        </div>
                    ...
                    <div class="card">
                        ...
                        @if($errors->any())
                            ...
                            ">
                                ...
                                Gagal menyimpan data. Pastikan format email benar dan ukuran foto maksimal 2MB.
                    ...
                    <div class="card">
                        ...
                        <div class="account-info-group">
                            ...
                            <div class="account-value">
                                {{ auth()->user()->created_at ? auth()->user()->created_at->format('j F Y') : '-' }}
                            </div>
                        ...
                        <div class="account-info-group">
                            ...
                            <div class="account-value">
                                {{ auth()->user()->updated_at ? auth()->user()->updated_at->format('j F Y H:i') : '-' }}
                            </div>
            ...
            <div class="card notification-card">
                ...
                <div class="notif-row">
                    ...
                    <div class="notif-info">
                        ...
                        <p>
                            Notifikasi saat customer mengirim permintaan buku baru.
                        </p>
                    ...
                    <label class="toggle-switch">
                        ...
                        <input type="checkbox"
                            ...
                            {{ (isset($notif['permintaan_buku_baru']) && $notif['permintaan_buku_baru'] === true) ? 'checked' : '' }}>
                ...
                <div class="notif-row">
                    ...
                    <div class="notif-info">
                        ...
                        <p>
                            Notifikasi saat ada perubahan status pekerjaan pencetakan.
                        </p>
                    ...
                    <label class="toggle-switch">
                        ...
                        <input type="checkbox"
                            ...
                            {{ (isset($notif['update_pencetakan']) && $notif['update_pencetakan'] === true) ? 'checked' : '' }}>
                ...
                <div class="notif-row">
                    ...
                    <label class="toggle-switch">
                        ...
                        <input type="checkbox"
                            ...
                            {{ (isset($notif['pesanan_diterima']) && $notif['pesanan_diterima'] === true) ? 'checked' : '' }}>
                ...
                <div class="notif-row">
                    ...
                    <div class="notif-info">
                        ...
                        <p>
                            Pelanggan membatalkan pesanan sebelum proses dilakukan.
                        </p>
                    ...
                    <label class="toggle-switch">
                        ...
                        <input type="checkbox"
                            ...
                            {{ (isset($notif['pembatalan_pesanan']) && $notif['pembatalan_pesanan'] === true) ? 'checked' : '' }}>
    ...
    <script>
            ...
            .addEventListener('change', function (event) {
                ...
                if (file) {
                    ...
                    reader.onload = function (e) {
                        ...
                        const container =
                            document.getElementById('avatarPreviewContainer');
        ...
        document.querySelectorAll('.notif-toggle-input')
