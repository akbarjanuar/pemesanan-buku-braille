...
<head>
    ...
    <title>Detail PIC - Admin Literasi Manual</title>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="content">
            <a href="{{ route('admin.manual.pic') }}" class="btn-back">
                &larr; Kembali
            </a>
            ...
            <div class="section-container">
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">: {{ $data['jabatan'] ?? 'Staf Literasi Manual' }}</span>
                    </div>
                    <div class="info-row">
    ...
    <div class="modal-overlay" id="modalAlihkan">
        <div class="modal-box">
            ...
            <form action="{{ route('admin.manual.pic.alihkan') }}" method="POST" class="modal-form">
                @csrf
