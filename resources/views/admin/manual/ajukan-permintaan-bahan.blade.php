...
<head>
    ...
    <title>Ajukan Permintaan Bahan - Admin Literasi Manual</title>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="content-area">
            <a href="{{ route('admin.manual.permintaan-bahan') }}" class="back-link">&larr; Kembali</a>
            ...
            <form method="POST" action="{{ route('admin.manual.permintaan-bahan.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-actions">
                    <a href="{{ route('admin.manual.permintaan-bahan') }}" class="btn-batal">Batal</a>
