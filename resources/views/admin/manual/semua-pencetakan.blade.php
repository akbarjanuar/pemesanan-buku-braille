...
<body>
    ...
    {{-- PERUBAHAN 1: partial nav diganti ke admin-manual-nav --}}
    @include('partials.admin-manual-nav', ['activeMenu' => $activeMenu ?? 'pencetakan'])
    ...
    <div class="main-wrapper">
        <header class="topbar">
            ...
            <div class="topbar-right">
                ...
                {{-- PERUBAHAN 2: route profile diarahkan ke admin.manual.profile (bukan admin.profile generik) --}}
            ...
            <div class="content-columns">
                ...
                <div>
                    ...
                    @if($menungguDiproses->count() == 0 && $sudahDiproses->count() == 0)
                        {{-- PERUBAHAN 3: teks empty-state diganti ke Literasi Manual --}}
    ...
    <script>
        (function () {
            ...
            btnMulaiProses.addEventListener('click', function () {
                ...
                fetch('/admin/manual/pencetakan/update/' + idTerpilih, {
                    method: 'POST',
                    headers: {
