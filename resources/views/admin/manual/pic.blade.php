...
<head>
    ...
    <title>PIC - Admin Literasi Manual</title>
    <!-- Font Awesome -->
...
<body>
    ...
    @include('partials.admin-manual-nav', ['activeMenu' => $activeMenu ?? 'pic'])
                        ...
                        @forelse($daftarPic ?? [] as $pic)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.manual.pic.detail', $pic->id) }}" class="btn-detail">Detail</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    <div class="modal-overlay" id="modalTambahPic">
        <div class="modal-box">
            ...
            <form action="{{ route('admin.manual.pic.store') }}" method="POST" class="modal-form">
                @csrf
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; }
        ...
        @media (max-width: 900px) {
            ...
            /* Tabel berubah menjadi card agar tidak terpotong di HP */
            .table-container {
                overflow: visible;
                border-radius: 12px;
            ...
            .pic-table td:nth-child(1)::before {
                content: "Nama PIC";
            }

            .pic-table td:nth-child(2)::before {
                content: "Nomor Telepon";
            }

            .pic-table td:nth-child(3)::before {
                content: "Pekerjaan Aktif";
            }

            .pic-table td:nth-child(4)::before {
                content: "Aksi";
            }
