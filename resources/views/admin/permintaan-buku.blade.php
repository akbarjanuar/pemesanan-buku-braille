    ...
    <div class="main-wrapper">
        ...
        <main class="content-area">
            ...
            <div class="page-header">
                ...
                <p>
                    Semua permintaan buku dari pelanggan.
                </p>
        ...
        (function () {
            ...
            var rows =
                document.querySelectorAll(
                    '.data-table tbody tr[data-status]'
                );
