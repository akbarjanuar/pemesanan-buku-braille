...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .notification-card { width: 66%; margin-top: 24px; }
...
<body>
    ...
    {{-- MEMANGGIL SIDEBAR KHUSUS ADMIN LITERASI DIGITAL --}}
    ...
    <div class="main-wrapper">
        ...
        <header class="topbar">
            ...
            <div class="topbar-right">
                <i class="far fa-bell notification-bell" style="font-size: 18px; color: var(--text-muted); cursor: pointer;"></i>
            </div>
        </header>
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="profile-grid">
                    ...
                    <div class="card profile-center">
                        ...
                        <div class="profile-role">Admin Literasi Digital &middot; Sentra Wyata Guna Bandung</div>
                    ...
                    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="Literasi Digital" disabled>
                    ...
                    <div class="card">
                        ...
                        <div class="account-info-group">
                            ...
                            <div class="account-value">{{ auth()->user()->created_at ? auth()->user()->created_at->format('j F Y') : '-' }}</div>
                        </div>
                        
                        <div class="account-info-group">
                            <div class="account-label">Terakhir Log In</div>
                            <div class="account-value">{{ auth()->user()->updated_at ? auth()->user()->updated_at->format('j F Y H:i') : '-' }}</div>
                        </div>
                    </div>
