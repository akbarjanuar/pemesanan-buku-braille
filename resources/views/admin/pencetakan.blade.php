...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .filter-bar { margin-bottom: 16px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; }
        ...
        .btn-buat-permintaan:hover { background-color: var(--primary-hover); }
        ...
        @media (max-width: 700px) {
            ...
            .btn-buat-permintaan { justify-content: center; }
        }
    </style>
</head>
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="content-area">
            ...
            <div class="filter-bar">
                ...
                <a href="/admin/pencetakan/buat" class="btn-buat-permintaan">
                    <i class="fas fa-plus"></i> Buat permintaan pencetakan
                </a>
            </div>
            ...
            <div class="printing-list">
                @forelse($daftarPencetakan as $cetak)
                    ...
                    <div class="printing-card" data-status="{{ $statusRaw }}">
                        ...
                        <div class="book-code">{{ $cetak->kode_cetak }}</div>
