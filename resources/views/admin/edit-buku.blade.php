...
<head>
    ...
    <title>Edit Buku - BrailleKita</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-control { width: 100%; padding: 12px 14px; border: 1px solid var(--border); border-radius: 8px; font-size: 14px; font-family: inherit; color: var(--text-dark); outline: none; }
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="content-area">
            ...
            <div class="form-card">
                <h2 class="form-title">Edit: {{ $buku->judul }}</h2>
                
                <form action="{{ route('admin.update-buku', $buku->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="stok" class="form-control" value="{{ old('stok', $buku->stok) }}" required min="0">
                        </div>
                        <div class="form-group">
                            <label>ISBN</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="batas_pemesanan" class="form-control" value="{{ old('batas_pemesanan', $buku->batas_pemesanan ?? 1) }}" required min="1">
                        </div>
                        <div class="form-group">
