...
<aside class="sidebar" id="adminManualSidebar">
    <div class="brand-logo">BrailleKita</div>

    <ul class="nav-menu">
        <a href="{{ route('admin.manual.dashboard') }}"
           class="nav-item {{ request()->routeIs('admin.manual.dashboard') ? 'active' : '' }}">
            <i class="fas fa-list-alt"></i> Dashboard
        </a>

        <a href="{{ route('admin.manual.pencetakan') }}"
           class="nav-item {{ request()->routeIs('admin.manual.pencetakan*') ? 'active' : '' }}">
            <i class="fas fa-print"></i> Permintaan Pencetakan
        </a>

        <a href="{{ route('admin.manual.pic') }}"
           class="nav-item {{ request()->routeIs('admin.manual.pic*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.manual.profile') }}"
           class="nav-item {{ request()->routeIs('admin.manual.profile') ? 'active' : '' }}">
...
<script>
    (function () {
        var sidebar = document.getElementById('adminManualSidebar');
